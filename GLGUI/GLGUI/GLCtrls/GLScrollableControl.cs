...
namespace GLGUI
{
    public class GLScrollableControl : GLCtrl
    {
        ...
        public GLScrollableControl(GLCtrlContainer container)
            : base(container)
        {
            Render += OnRender;
            ...
            horizontal = base.Add(new GLSlider(container) { Direction = GLSliderOrientation.Horizontal/*, Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom*/ });
            vertical = base.Add(new GLSlider(container) { Direction = GLSliderOrientation.Vertical/*, Anchor = AnchorStyles.Top | AnchorStyles.Right | AnchorStyles.Bottom*/ });
            content = base.Add(new GLScrolledControl(container) { /*Anchor = AnchorStyles.Left | AnchorStyles.Top | AnchorStyles.Right | AnchorStyles.Bottom*/ });
